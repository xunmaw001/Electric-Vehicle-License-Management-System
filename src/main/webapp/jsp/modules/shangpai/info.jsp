            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">上牌信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xuanpaiName" name="xuanpaiName" class="form-control"
                                                   v-model="ruleForm.xuanpaiName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xuanpaiValue" name="xuanpaiValue" class="form-control"
                                               v-model="ruleForm.xuanpaiValue" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="zhuangtaiValue" name="zhuangtaiValue" class="form-control"
                                               v-model="ruleForm.zhuangtaiValue" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="diandongcheValue" name="diandongcheValue" class="form-control"
                                               v-model="ruleForm.diandongcheValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xuanpaiId" name="xuanpaiId" v-model="ruleForm.xuanpaiId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>审核状态</label>
                                    <input id="shangpaiValue" name="shangpaiValue" class="form-control"
                                           v-model="ruleForm.shangpaiValue" readonly>
                                </div>
