...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">选牌信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">选牌信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">选牌信息列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        车牌类型
                                        <div class="layui-input-inline">
                                            <select name="xuanpaiTypesSelectSearch"  style="width: 150px;" id="xuanpaiTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        车牌状态
                                        <div class="layui-input-inline">
                                            <select name="zhuangtaiTypesSelectSearch"  style="width: 150px;" id="zhuangtaiTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //车牌类型
            var xuanpaiTypesCell = document.createElement('td');
            xuanpaiTypesCell.innerHTML = item.xuanpaiValue;
            row.appendChild(xuanpaiTypesCell);


            //车牌状态
            var zhuangtaiTypesCell = document.createElement('td');
            zhuangtaiTypesCell.innerHTML = item.zhuangtaiValue;
            row.appendChild(zhuangtaiTypesCell);
            ...
            if(item.zhuangtaiTypes == 1){
                //修改按钮
                var editBtn = document.createElement('button');
                var editAttr = 'xuanzhe(' + item.id + ')';
                editBtn.setAttribute("type", "button");
                editBtn.setAttribute("class", "btn btn-primary btn-sm 选择");
                editBtn.setAttribute("onclick", editAttr);
                editBtn.innerHTML = "选择牌号";
        ...
        // 删除
        function xuanzhe(id) {
            var mymessage = confirm("真的要选择这个车牌吗？");
            if (mymessage == true) {
                http("shangpai/xuanzhe?ids="+id, "get", {}, (res) => {
                    if(res.code == 0){
                    getDataList();
                    alert('操作成功');
                }
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xuanpai/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxuanpai", "addxuanpai");
            window.location.href = "add-or-update.jsp"
        }
