...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        电动车类型
                                        <div class="layui-input-inline">
                                            <select name="diandongcheTypesSelectSearch"  style="width: 150px;" id="diandongcheTypesSelectSearch" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //电动车类型
            var diandongcheTypesCell = document.createElement('td');
            diandongcheTypesCell.innerHTML = item.diandongcheValue;
            row.appendChild(diandongcheTypesCell);
