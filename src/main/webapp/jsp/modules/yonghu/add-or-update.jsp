                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>电动车类型</label>
                                        <select id="diandongcheTypesSelect" name="diandongcheTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>驾照类型</label>
                                        <select id="xuanpaiTypesSelect" name="xuanpaiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>身份证号</label>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationDiandongchetypesSelect(){
            var diandongcheTypesSelect = document.getElementById('diandongcheTypesSelect');
            if(diandongcheTypesSelect != null && diandongcheTypesOptions != null  && diandongcheTypesOptions.length > 0 ){
                for (var i = 0; i < diandongcheTypesOptions.length; i++) {
                    diandongcheTypesSelect.add(new Option(diandongcheTypesOptions[i].indexName,diandongcheTypesOptions[i].codeIndex));
                }
            }
        }
        function initializationXuanpaitypesSelect(){
            var xuanpaiTypesSelect = document.getElementById('xuanpaiTypesSelect');
            if(xuanpaiTypesSelect != null && xuanpaiTypesOptions != null  && xuanpaiTypesOptions.length > 0 ){
                for (var i = 0; i < xuanpaiTypesOptions.length; i++) {
                    xuanpaiTypesSelect.add(new Option(xuanpaiTypesOptions[i].indexName,xuanpaiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(diandongcheTypesSelect != null && diandongcheTypesOptions != null  && diandongcheTypesOptions.length > 0 ) {
            for (var i = 0; i < diandongcheTypesOptions.length; i++) {
                if (diandongcheTypesOptions[i].codeIndex == ruleForm.diandongcheTypes) {//下拉框value对比,如果一致就赋值汉字
                        diandongcheTypesSelect.options[i].selected = true;
                }
            }
        }
        ...
        if(xuanpaiTypesSelect != null && xuanpaiTypesOptions != null  && xuanpaiTypesOptions.length > 0 ) {
            for (var i = 0; i < xuanpaiTypesOptions.length; i++) {
                if (xuanpaiTypesOptions[i].codeIndex == ruleForm.xuanpaiTypes) {//下拉框value对比,如果一致就赋值汉字
                        xuanpaiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuName: "required",
                sexTypes: "required",
                diandongcheTypes: "required",
                xuanpaiTypes: "required",
            ...
            messages: {
                ...
                yonghuName: "用户姓名不能为空",
                sexTypes: "性别不能为空",
                diandongcheTypes: "电动车类型不能为空",
                xuanpaiTypes: "驾照类型不能为空",
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationDiandongchetypesSelect();
            initializationXuanpaitypesSelect();
            <!--  初始化级联表的下拉框  -->
